    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="PaintingControllerServlet" method="POST">
                ...
                <input type="hidden" name="paintingId" value="${THE_PAINTING.id}">

                <table>
                    <tbody>
                        <tr>
                            <td><label>Title</label></td>
                            <td><input type="text" name="title" value="${THE_PAINTING.title}"></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <select name="painter">
                                    <c:forEach var="tempPainter" items="<%= session.getAttribute("PAINTER_LIST")%>">
                                        <option value="${tempPainter.id}" ${tempPainter.id == selectedPainter ? 'selected="selected"' : ''}>${tempPainter.firstName} ${tempPainter.lastName}</option>
                                    </c:forEach>
                                </select>
                            </td>
                        </tr>
